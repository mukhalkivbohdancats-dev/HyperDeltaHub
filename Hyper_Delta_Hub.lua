--[[
    ================================================================
    [ SCRIPT INFORMATION ]
    Project: Hyper Delta Hub 
    Author: Bohdancatnapcats50 
...
local Config = {
    ...
    ServiceId       = 29223, -- Your PlatoBoost Service ID
    PlatoSecret     = "b2ddae15-1581-41ab-a4f0-8111ead283d6", -- Your PlatoBoost Secret Key
    ...
    HubDescription  = "Script with many functions" -- The text shown below the title
}
